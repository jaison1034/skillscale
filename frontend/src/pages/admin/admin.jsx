  ...
  <span className="text-white">⬅️ Logout</span>
      ...
      <div className="flex flex-1">
        ...
        <div className={`fixed lg:relative top-0 left-0 w-64 bg-[#140000] text-[#F7F7F7] p-4 transition-transform transform ${
          ...
          <h2 className="text-xl font-bold mb-6 bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500 bg-clip-text border-b border-[#EA033F]/30 pb-3">Admin Panel</h2>
        ...
        <div className="flex-1 p-6 bg-white/10 backdrop-blur-sm">
          <p className="text-4xl text-left bg-gradient-to-r from-orange-500 via-pink-500 to-purple-500 bg-clip-text mb-6 font-bold">Welcome to the Admin Dashboard</p>
